<template>
  ...
  <panel title="数据趋势">
    ...
    <vue-echarts :option="lineOption" :theme="theme" ref="trendLineRef" style="height: 350px" />
  </panel>
...
const { chartConfig: quarterConfig, setLineBarChart: setLineBarChartQuarter } = useBarLineChart()
...
const { chartConfig: monthConfig, setLineBarChart: setLineBarChartMonth } = useBarLineChart()
